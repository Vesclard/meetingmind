...
| R6 | **No "Reset app" affordance** (handoff P2) and no loading state during the sign-in data fetch beyond static text. ✅ *reset fixed & verified 2026-07-10 (Phase 2.4); loading skeleton is Phase 2.5, still open.* | Papercuts |
